...
QT_MOC_LITERAL(3, 20, 18) // "std::vector<bool>&"

    },
    "State\0valueChanged\0\0std::vector<bool>&"
};
...
void State::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->valueChanged((*reinterpret_cast< std::vector<bool>(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (State::*_t)(std::vector<bool> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&State::valueChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void State::valueChanged(std::vector<bool> & _t1)
{
